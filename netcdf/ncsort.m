function [nc,variablenames,numbervariables,dimorder]=ncsort(nc)

% NCSORT - Reorders and grooms a netcdf structure
% 
% function [nc,variablenames,numbervariables,dimorder]=ncsort(nc)
%
% Input:
% nc - netcdf data structure defined in ncstruct.
%
% Output:
...
% dimorder        - order of dimensions listed in ncstructure
%
...
if numbers ~= numbervariables ; 
	...
	disp(['Expected variables: ',nccellcat(names)]);
	disp(['Actual variables: ',nccellcat(variablenames)]);
