function [nc]=ridgepack_ncadd(nc,name,data,long_name,dimension,units,type,title)

% function [nc]=ridgepack_ncadd(nc,name,data,long_name,dimension,units,type,title)
%
% This function is part of Ridgepack Version 1.0.
% It adds a variable to a netCDF structure.  To learn more about netCDF 
% structures, see function ncstruct.  The nc structure variable nc may 
% be omitted from the input list if the structure does not exist, so 
% that the function can also be run as:
%
% INPUT:
