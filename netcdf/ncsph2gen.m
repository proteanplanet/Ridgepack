function [nc,calc]=ncsph2gen(nc)

% NCSPH2GEN - Convert nc structure from lat-lon dimensions to general coordinates
%
% function [nc,calc]=ncsph2gen(nc)
%
...
if calc 
 ...
 % create x and y
 nc=ncadd(nc,'x',[1:length(nc.longitude.data)],'x-coordinate in Cartesian system',...
          {'x'},'','NC_FLOAT');
 nc=ncadd(nc,'y',[1:length(nc.latitude.data)],'y-coordinate in Cartesian system',...
          {'y'},'','NC_FLOAT');
