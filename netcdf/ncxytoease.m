function [lat,lon,h,k]=ncxytoease(s,r,s0,r0,C,SGN)

% NCXYTOEASE - Convert indices on Azimuthal Polar EASE grid to lat-long
%
% function [lat,lon,h,k]=ncxytoease(r,s,SGN)
% 
