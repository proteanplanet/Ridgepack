function [varadd]=ridgepack_consistency(nc1,nc2)

% ridgepack_consistency - Check the consistency of two nc structures
%
% function [varadd]=ridgepack_consistency(nc1,nc2)
%
% This is a sub-function of ridgepack_merge to check that common variables between two
...
for m=1:numbervariables1
 ...
 if isfield(nc2,name1)
  [v1,n1]=ridgepack_name(nc1.(name1));
  for n=1:n1
   sub1=char(v1(n));
