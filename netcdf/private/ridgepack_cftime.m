function [time]=ridgepack_cftimeextern(time,units,CFcalendar)

% ridgepack_cftime - Converts CF convention time to Matlab serial time with udunits
%
...
if isunix;
   ...
   error('Can only use ridgepack_cftime with Linux, UNIX or Mac OS X systems')
