function nc=ncgrid_ssmi(nc,ns,n,res,xsize,ysize)

% NCGRID_SSMI - Provides lat and lon for the old ssmi grid
%
% function nc=ncgrid_ssmi(nc)
%
...
% PLAY WITH MAXDIST IF THERE ARE CONTOURING PROBLEMS USING NCCONTOURM
...
for j=1:maxdisty;
 ...
 [nc.latitude.data(i,j),nc.longitude.data(i,j),SLAT]=ncxytogeodetic(xabscissa(i),yordinate(j),SGN);
