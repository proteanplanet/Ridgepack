...
for nrun=1:nruns
 ...
 maskvnh=find(nclatv.latVertex.data>40*pi/180);
 ...
 maskcnh=find(nclatc.latCell.data>40*pi/180);
 ...
 maskvsh=find(nclatv.latVertex.data<-40*pi/180);
 ...
 maskcsh=find(nclatc.latCell.data<-40*pi/180);
