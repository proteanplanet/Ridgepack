...
ensemblenames={'V3.LR.piControl','V3.LR.10PSU'};
...
casenames={'20231209.v3.LR.piControl-spinup.chrysalis',...
           '20240109.v3.LR.piControl.10psu.chrysalis'};
...
% get case and ensemble locations
dirnames{1}=['/Users/afroberts/data/MODEL/E3SM/v3LRspinup'];
eprnames{1}=['/Users/afroberts/data/MODEL/E3SM/v3LRspinup/processed'];
dirnames{2}=['/Users/afroberts/data/MODEL/E3SM/v310psu'];
eprnames{2}=['/Users/afroberts/data/MODEL/E3SM/v310psu/processed'];
