...
cd(['/Volumes/CICESatArray/MODEL/E3SM/v2/',casenow,'/grid'])
gridfile='mpassi.rst.0002-01-01_00000.nc';
...
%coastname=[casenow,'_Coast.nc'];
if rows==1
 coastname=['EC30to60E2r2_Coast.nc'];
elseif rows==1
 coastname=['E3SM_WC14_V1_C_grid_Coast.nc'];
end
x=dir(coastname);
if isempty(x)
...
%headers={'March','September'};
%if cols==1
% minmonth=3;maxmonth=3;
%elseif cols==2
% minmonth=9;maxmonth=9;
%end
