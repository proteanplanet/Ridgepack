...
filenames={'Pathfinder',...
           'v3.LR.historical_0051.mpassi.daily',...
           'v3.LR.historical_0101.mpassi.daily',...
           'v3.LR.historical_0151.mpassi.daily',...
           'v3.LR.historical_0201.mpassi.daily',...
           'v3.LR.historical_0251.mpassi.daily'};

locations={'/Users/afroberts/data/data/SATELLITE/processed/pathfinder_v4',...
           '/Users/afroberts/data/MODEL/E3SM/v3/v3.LR.historical_0051/hist/processed',...
           '/Users/afroberts/data/MODEL/E3SM/v3/v3.LR.historical_0101/hist/processed',...
           '/Users/afroberts/data/MODEL/E3SM/v3/v3.LR.historical_0151/hist/processed',...
           '/Users/afroberts/data/MODEL/E3SM/v3/v3.LR.historical_0201/hist/processed',...
           '/Users/afroberts/data/MODEL/E3SM/v3/v3.LR.historical_0251/hist/processed'}

rnametags={'Pathfinder',...
           'LR 051','LR 101','LR 151','LR 201','LR 251'};
...
for cols=1:length(monthsets)
 for rows=1:length(nruns)
  ...
  if strcmp(char(filenames{nruns(rows)}),'Pathfinder')
   ...
   if strcmp(filenames{nruns(rows)},'v3.NARRM.historical_0051.mpassi.daily') | ...
      strcmp(filenames{nruns(rows)},'v3.NARRM.historical_0101.mpassi.daily') | ...
      strcmp(filenames{nruns(rows)},'v3.NARRM.historical_0151.mpassi.daily') | ...
      strcmp(filenames{nruns(rows)},'v3.NARRM.historical_0201.mpassi.daily') | ...
      strcmp(filenames{nruns(rows)},'v3.NARRM.historical_0251.mpassi.daily') 
