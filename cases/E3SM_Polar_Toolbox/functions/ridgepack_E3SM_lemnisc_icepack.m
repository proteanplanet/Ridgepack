...
ensemblenames={'Control','Icepack'};

legnames={'Control','Icepack 1.5'};

ensemblecases={[1],[2]};

yearrange={[1850 1950],[1850 1950]};
...
casenames={'v3.LR.historical_0051',...
           'v3.LR.icepack.historical_0051'}

dirnames={'/Users/afroberts/work/Icepack_15_Control',...
          '/Users/afroberts/work/Icepack_15_Test'}
...
for kcols=1:maxcols
 ...
 for l=1:nlemn
  ...
  elseif l<nlemniscs % not compared with observations
   ...
   df = (equiv1+equiv2-2);
   tcrit=tinv(0.9995,df); % change 0.9995 99.9%, 0.995 99%, 0.975 95%
   hcrit=ones(size(t));
   hcrit(isnan(t))=0;
