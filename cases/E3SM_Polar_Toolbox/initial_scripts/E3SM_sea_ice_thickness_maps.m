...
ridgepack_multiplot(2,3,rows,cols,alpha(k));
...
if cols==1
  ...
  if rows==1
   ...
   title('v0 HR','FontSize',12) 
   ylabel('March','FontSize',12)
  elseif rows==2
   ylabel('September','FontSize',12)
  else
   error('rows out of luck')
  end
...
if arctic
 ridgepack_fprint('png','E3SM_HR_V1_Sea_Ice_Thickness_Arctic',1,2);
 ridgepack_fprint('epsc','E3SM_HR_V1_Sea_Ice_Thickness_Arctic',1,2);
else
 ridgepack_fprint('png','E3SM_HR_V1_Sea_Ice_Thickness_Southern_Ocean',1,2);
 ridgepack_fprint('epsc','E3SM_HR_V1_Sea_Ice_Thickness_Southern_Ocean',1,2);
end
