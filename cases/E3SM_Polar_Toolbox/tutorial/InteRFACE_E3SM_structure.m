% InteRFACE_E3SM_structure: Tutorial Script
%
% Illustration of how to ingest netcdf data for use with
% Ridgepack, and sea ice data in particular.
%
