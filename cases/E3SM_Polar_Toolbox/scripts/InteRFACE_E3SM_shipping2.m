...
nc=ridgepack_clone(datafile,fields);
...
[cell,oncell,celllist,oncelllist,celldist,cellarea]=...
...
if globeplot
 ...
 mask=find(nc.timeMonthly_avg_iceAreaCell.data<0.75);
