function [seaiceareaNh,seaiceareaSh]=ridgepack_E3SM_sea_ice_cpl_heat_check(filename)
...
formatSpec = '%16C%15f%15f%15f%15f%15f%f%[^\n\r]';
...
temp = table(dataArray{1:end-1}, 'VariableNames', {'descriptor','atm','lnd','ocn','iceNh','iceSh','sum'});
...
for i=1:length(temp.sum); 
  seaiceareaNh(i)=temp.iceNh(i);
  seaiceareaSh(i)=temp.iceSh(i);
end
